...
from src.crawler.http_client import fetch
...
def pdf_text_has_kajetany(content_bytes: bytes) -> bool:
    global i
    i += 1
    print(f"PDF check {i}")
...
def get_parsing_details(item: Node, base_url: str) -> Elements | None:
